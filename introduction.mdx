...
Welcome to the Junction users and developers documentation! We’re excited to help you understand our products or integrate our solution quickly and easily. Let’s get started!
  ...
  <div className="px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      <HeroCard 
        img="/API.png" 
        title="API" 
        description="Seamlessly integrate DeFi features into your application and start generating revenue." 
        href="/junction-api/introduction" 
      />

      <HeroCard
        img="/Exchange.png"
        title="Exchange"
        description="Trade, Earn... and manage your portfolio across all blockchains."
        href="/junction-exchange/introduction"
      />

      <HeroCard
        img="/Earn.png"
        title="Earn"
        description="Generate earning with referrals, activities and in-app quests."
        href="/junction-earn/introduction"
      />

      <HeroCard
        img="/Connector.png"
        title="Connector"
        description="Connect with your favorite wallet or social application and discover new opportunities."
        href="/junction-connector/introduction"
      />
    </div>
  </div>
</div>
